...
@section('content')
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>运行环境</label><span>{{$_SERVER['SERVER_SOFTWARE']}}&nbsp;&nbsp;&nbsp;&nbsp;{{PHP_VERSION}}</span>
                </li>
                <li>
                    <label>版本</label><span>v-1.0</span>
                </li>
                <li>
                    <label>上传附件限制</label><span><?php echo get_cfg_var('upload_max_filesize')?get_cfg_var('upload_max_filesize'):'不允许文件上传' ?></span>
                </li>
                <li>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>官方交流网站：</label><span><a href="#">http://cchenhuiyu.com</a></span>
                </li>
                <li>
